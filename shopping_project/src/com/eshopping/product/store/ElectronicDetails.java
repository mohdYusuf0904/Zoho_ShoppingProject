...
public class ElectronicDetails {
	...
	public String getWashingMachineWarrantyDetails() {
		...
		return "|Warranty Summary :" + "3 Years Warranty on Product and 10 Years Warranty on Motor from Samsung\r\n"
				+ "|Covered in Warranty : "
	...
	public String getMobileWarrantyDetails() {
		return "|Warranty Summary " + ": 1 Year on Handset and 6 Months on Accessories\r\n" + "|Domestic Warranty :"
				+ " 1 Year";
	}

	public String getMobileAdditionDetails() {

		return "Smartphone : " + "Yes\r\n" + "|SIM Size : " + "Nano\r\n" + "|User Interface : "
	...
	public String getAdditionDetails() {
		...
		return "Disk Drive :" + " Not Available\r\n" + "|Web Camera : " + " 720p (With Think Shutter)\r\n"
