...
public class SignupUi {
	...
	private void setEmail(User u) {
		...
		while(UserManager.getInstance().isEmailAlreadyHas(u.getEmail())|| !UserManager.getInstance().isValidEmail(u.getEmail()))
		{
	...
	private void setPhone(User u)
	{
		...
		while(u.getPhone().length()<10 || u.getPhone().length()>10)
		{
